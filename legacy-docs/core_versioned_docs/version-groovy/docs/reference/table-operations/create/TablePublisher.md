...
The `TablePublisher` class creates a [blink table](../../../conceptual/table-types.md/#blink) from tables that are added to it via the [`add`](#methods) method.
...
- [How to use TablePublisher](../../../how-to-guides/table-publisher.md)
