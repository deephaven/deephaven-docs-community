---
id: gcp-linux
title: How to use Deephaven in a GCP Linux instance
sidebar_label: Use Deephaven with GCP
---
...
A Google Cloud VM can be configured to run Docker containers on startup. Since Deephaven can be [launched from pre-built Docker images](https://deephaven.io/core/docs/tutorials/quickstart/), that will make running Deephaven in the cloud a breeze.
...
- The restart policy is defined by [Docker's restart policies](https://docs.docker.com/engine/reference/run/#restart-policies-restart). We will use the `On failure` option so that the container restarts if it crashes.
...
![img](../assets/how-to/gcloud-container-opts.jpg)
...
This guide will not cover persistent storage in the cloud. There are several options, including [Docker data volumes](/core/docs/conceptual/docker-data-volumes/) and [gcloud storage](https://cloud.google.com/sdk/gcloud/reference/storage), for workflows that require storage of large datasets.
...
![img](../assets/how-to/gcloud-docker-ls.jpg)
...
![img](../assets/how-to/dhc-on-gcloud.jpg)

## Related documentation

- [Docker install guide](/core/docs/tutorials/docker-install.md/)
- [Learn Deephaven](/core/docs/tutorials/quickstart/)
- [How to use Deephaven with AWS EC2](/core/docs/how-to-guides/aws-ec2/)
- [Docker data volumes](/core/docs/conceptual/docker-data-volumes/)
