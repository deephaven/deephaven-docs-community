---
id: python-errors
title: How to decipher Python error messages
sidebar_label: Decipher Python errors
---
...
![img](../assets/python-error-failed-table.png)
...
- [How to use formulas](./formulas-how-to.md)
- [User-defined functions](/core/docs/reference/query-language/formulas/user-defined-functions/)
- [Query language formulas](/core/docs/reference/query-language/formulas/)
